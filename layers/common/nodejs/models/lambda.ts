...
//export interface ILambdaRequest<T, U, V> extends InvocationRequest {
//_FunctionName: AWS.Lambda.FunctionName | undefined;
// FunctionName: T;
// Payload?: AWS.Lambda._Blob | undefined;
// InvocationType?: U;
// _LogType?: V;
// _Qualifier?: AWS.Lambda.Qualifier | undefined;
// getFunctionName: () => AWS.Lambda.FunctionName | T;
// getPayload: () => AWS.Lambda._Blob | undefined;
// getInvocationType: () => AWS.Lambda.InvocationType | U | undefined;
// getLogType: () => AWS.Lambda.LogType | V | undefined;
// getQualifier: () => AWS.Lambda.Qualifier | undefined;
// setFunctionName: (functionName: T) => this;
// setPayload: (payload: AWS.Lambda._Blob) => this;
// setInvocationType: (invocationType: U) => this;
// setLogType: (logType: V) => this;
// setQualifier: (qualifier: AWS.Lambda.Qualifier) => this;
// toInvocationRequest: () => AWS.Lambda.InvocationRequest;
//}

// const x = new LambdaInvoker(FunctionName.LingueeProxyController)._request.setPayload('s');
// /**
//  * Lambda methods
//  */
// getFunctionName: () => AWS.Lambda.NamespacedFunctionName;
// getRequestPayload: () => AWS.Lambda._Blob | undefined;
// getInvocationType: () => AWS.Lambda.InvocationType | undefined;
// getLogType: () => AWS.Lambda.LogType | undefined;
// getQualifier: () => AWS.Lambda.Qualifier | undefined;
// setFunctionName: (functionName: AWS.Lambda.NamespacedFunctionName) => this;
// setRequestPayload: (payload: AWS.Lambda._Blob) => this;
// setInvocationType: (invocationType: AWS.Lambda.InvocationType) => this;
// setLogType: (logType: AWS.Lambda.LogType) => this;
// setQualifier: (qualifier: AWS.Lambda.Qualifier) => this;
// /**
//  * LambdaResponse methods
//  */
// getStatusCode: () => AWS.Lambda.Integer | undefined;
// getExecutedVersion: () => string | undefined;
// getFunctionError: () => string | undefined;
// getLogResult: () => string | undefined;
// getResponsePayload: () => AWS.Lambda._Blob | undefined;
