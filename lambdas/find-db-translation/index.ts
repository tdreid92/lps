...
const resolveTranslations = async (translationKey: any, reversedTranslationKey: any) => {
...
exports.handler = async (event: { translationKey: any; reversedTranslationKey: any; }) => {
  console.log(event);
