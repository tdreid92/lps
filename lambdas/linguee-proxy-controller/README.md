...
* app.ts - this file contains the sample Node.js code for the web service
* index.ts - this file contains the AWS Lambda handler code
...
changes to the sample code.  We suggest making a small change to app.ts first,
